...
instance
  ...
  GHasDependencies (Proxy nodeTy) (Proxy depsTy) (Either node Void) (Either deps Void)
  where
...
instance
  ...
  GHasDependencies (Proxy nodeTy) (Proxy depsTy) (Either left (Either right rest)) (Either deps Void)
  where
  genericDependsOn _ _ _ _ = error "Impossible"
...
instance
  ...
  GHasDependencies (Proxy nodeTy) (Proxy depsTy) (Either node Void) (Either left (Either right rest))
  where
  genericDependsOn _ _ _ _ = error "Impossible"
...
instance
  ...
  GHasDependencies (Proxy nodeTy) (Proxy depsTy) (Either left1 (Either right1 rest1)) (Either left2 (Either right2 rest2))
  where
  genericDependsOn _ _ _ _ = error "Impossible"
