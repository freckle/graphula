...
/* package graphula-persistent-0.1.0 */
#ifndef VERSION_graphula_persistent
#define VERSION_graphula_persistent "0.1.0"
#endif /* VERSION_graphula_persistent */
#ifndef MIN_VERSION_graphula_persistent
#define MIN_VERSION_graphula_persistent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_graphula_persistent */
...
#define CURRENT_PACKAGE_KEY "graphula-persistent-0.1.0-4e7yTwa5KSn8T6sZnXQlEO"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "graphula-persistent-0.1.0-4e7yTwa5KSn8T6sZnXQlEO"
